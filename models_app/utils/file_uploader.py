...
from models_app.models.history import BaseModel


def uploaded_file_path(instance: BaseModel, filename: str) -> str:
    # import pdb
    # pdb.set_trace()
...
def skip_saving_file(sender: BaseModel, instance: BaseModel, **kwargs):
...
def save_file(sender: BaseModel, instance: BaseModel, created: bool, **kwargs):
